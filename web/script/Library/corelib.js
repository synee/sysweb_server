...
(function() {
  $(function() {
    var Applicatins, Class, Environment, Events, Library, Memory, User, fs, init, _Sys, _extend;
    ...
    Applicatins = window.Sysweb.Applicatins = (function() {
      var _Apps;
      _Apps = _Sys.extend({
        initialize: function() {
          return this._apps = {};
